---
name: MCV5 Dashboard UX Overhaul
description: Autonomous UX overhaul of MCV5 dashboard — status, architecture, and remaining work
type: project
---

MCV5 dashboard UX overhaul was done autonomously across 2 sessions (12 commits total).

**Why:** Matthias wanted a polished, production-grade dashboard ("fertiges Hammerprojekt").

**How to apply:** When working on MCV5 dashboard, the architecture is:
...
- MCV5 runs on port 8205 (NOT 8200 — that's MCV4)
